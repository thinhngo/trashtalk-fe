...
export default class Location extends Record({
  ...
  isAt(otherLocation) {
    // Method to determine if one location is at the same location as the other.
    // We may decide to refine this logic at some point to allow two locations to be the
